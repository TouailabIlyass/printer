...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('storage/plugins/images/favicon.png')}}">
    <!-- Custom CSS -->
    ...
    <!-- Custom CSS -->
    <link href="{{asset('storage/plugins/css/style.min.css')}}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{asset('storage/plugins/bower_components/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset('storage/plugins/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('storage/plugins/js/app-style-switcher.js')}}"></script>
    <script src="{{asset('storage/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('storage/plugins/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('storage/plugins/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('storage/plugins/js/custom.js')}}"></script>
    ...
    <script src="{{asset('storage/plugins/js/pages/dashboards/dashboard1.js')}}"></script>
</body>
